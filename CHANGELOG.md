...
## [2.56.0](https://github.com/DryKillLogic/comet/compare/v2.55.0...v2.56.0) (2026-07-25)


### Features

* add `parsed_matches_target` utility and use it to centralize season/episode filtering logic ([47b79ee](https://github.com/DryKillLogic/comet/commit/47b79ee7fb0e4131ebe595da37c54be0a0f753a8))
* add Debrid Account Scraper feature description to README ([4f4e351](https://github.com/DryKillLogic/comet/commit/4f4e3518e48b01d3d543a2750d44d7f63afbe4c5))
* add effective peer address resolution for WebSocket connections ([0a80dd4](https://github.com/DryKillLogic/comet/commit/0a80dd4092e6e1e4d714da613e609148a1abd01e))
* add INDEXER_LANGUAGES setting for multi-language title support ([426a74b](https://github.com/DryKillLogic/comet/commit/426a74b8d68c45179cfef8d19b9bd2ade66ca113))
* add live preview for result format selection in the UI ([5394a40](https://github.com/DryKillLogic/comet/commit/5394a40777d864b281c0ec112ca3989038e66e7f))
* add live preview for result format selection in the UI ([8d5ef18](https://github.com/DryKillLogic/comet/commit/8d5ef18843947a49e003add3f142c09a27eba4e9))
* add memory management features to optimize resource usage ([76ccb4d](https://github.com/DryKillLogic/comet/commit/76ccb4d690670745096bf67720db0537e9687880))
* add method to reset discovery hysteresis in BackgroundScraperWorker for improved task management ([2a97dda](https://github.com/DryKillLogic/comet/commit/2a97ddafde9b5a9be95e8761b7b8ac0e7d80a4a9))
* add series episode index refresh functionality ([f028b22](https://github.com/DryKillLogic/comet/commit/f028b2209e0e8b0a4eb33d823ce2780e40f9438d))
* add series episode index refresh table to migration schema ([ac232f5](https://github.com/DryKillLogic/comet/commit/ac232f5fca9cb123b3ec7d7d3688fd8029632c0d))
* add Stremio API prefix support in Kodi plugin and update settings ([c6d5587](https://github.com/DryKillLogic/comet/commit/c6d5587448242f33c8be5d2b70893116c712c15d))
* allow Kodi setup codes to be 6-16 characters long and update related prompts ([1c5b963](https://github.com/DryKillLogic/comet/commit/1c5b9634d8e423cc4943191baf17f20bd2b7e2bd))
* **background-scraper:** add graceful stop after current run ([ed9403d](https://github.com/DryKillLogic/comet/commit/ed9403d829d12995e1df2165ff59d3a86360f6f0))
* **background-scraper:** add graceful stop after current run ([afa3de2](https://github.com/DryKillLogic/comet/commit/afa3de2e4f60d10266cd3d9daa7cb7b5bfb7140c))
* **background-scraper:** enhance drain endpoint for graceful stop and idempotency ([e391e10](https://github.com/DryKillLogic/comet/commit/e391e10f247157289850ec313ea19099cfcd7f2b))
* **cometnet:** make websocket compression configurable ([79a681c](https://github.com/DryKillLogic/comet/commit/79a681c3aaf14ab2d78cf8dbdd7ac32a5633e757))
* **dependencies:** add dev dependency group for pytest ([a78841e](https://github.com/DryKillLogic/comet/commit/a78841e68d465b2bcf88a9085b2851d3ea4dd24c))
* **docker:** update Dockerfile to use slim images and improve package installation ([403b1dc](https://github.com/DryKillLogic/comet/commit/403b1dc1fe8fc299e010385b1ed0945def0177ab))
* enforce strict episode matching with air-date indexing ([d74d2ee](https://github.com/DryKillLogic/comet/commit/d74d2ee8745839fe8f577089fdd4833601938cc1))
* enforce strict episode matching with air-date indexing ([aebaf73](https://github.com/DryKillLogic/comet/commit/aebaf7390d40eb806d65751ca678f9855d1122ed))
* enhance admin and configuration session management with secure token handling and improved session validation ([6c0e943](https://github.com/DryKillLogic/comet/commit/6c0e943847cb1980a2fdf6ded7af28d77d51b645))
* enhance admin dashboard with background scraper next cycle display and controls ([c2ce896](https://github.com/DryKillLogic/comet/commit/c2ce896cc19fa1378078f83cfcb42aa663a0408f))
* enhance database functionality with new predicates and JSON handling ([21ebac8](https://github.com/DryKillLogic/comet/commit/21ebac83524923e754726d91770b9c33503cc7d1))
* enhance debrid account cleanup with provider filtering and anime type resolution ([d2b2a77](https://github.com/DryKillLogic/comet/commit/d2b2a77618277c3dd573c08bd1636bd678da9695))
* enhance formatting functions with customizable styles for components and streamline secret string handling in Kodi setup ([3799022](https://github.com/DryKillLogic/comet/commit/3799022b6095fb0c3dcee9785022ec83ee2fa300))
* enhance indexer title search with canonical and original title options ([52c51fd](https://github.com/DryKillLogic/comet/commit/52c51fd6243cfa93a8670bb255b253682de0e81a))
* enhance memory management with mimalloc support ([54f3f06](https://github.com/DryKillLogic/comet/commit/54f3f062e71b2ec0e2d4fd46fe2a84888696cfa7))
* enhance session security and validation in configuration endpoints with improved token handling and error management ([94a5af2](https://github.com/DryKillLogic/comet/commit/94a5af2cf5110ead6fd42e4d1ca0d12b16bd04a0))
* Enhance TMDB integration and remove Trakt dependency ([24238ed](https://github.com/DryKillLogic/comet/commit/24238ed0234ea539364f4984fbe7e4e4e894f516))
* enhance URL handling in scrapers with context-aware parsing ([8546296](https://github.com/DryKillLogic/comet/commit/8546296d3394df2a8c84679dc1bb6513002567c9))
* filter episodes based on the retry status of their associated series item ([0696166](https://github.com/DryKillLogic/comet/commit/06961667fe9053e8755fc49ee0cbcd7c803aa99d))
* **healthcheck:** implement healthcheck module and update Dockerfile for healthcheck command ([be7e691](https://github.com/DryKillLogic/comet/commit/be7e6911282ecf6ed611687c70279f52701d4820))
* **imdb:** enhance title matching to return nearest match for year ([1e5874e](https://github.com/DryKillLogic/comet/commit/1e5874ea755eda1969cdf9677ea133612f5a21c1))
* implement a custom Kodi setup dialog with dedicated error alerts and expand the Kodi add-on documentation ([526c6e2](https://github.com/DryKillLogic/comet/commit/526c6e2c2d55ccfea9a18bf040475e4c499542d2))
* implement a custom Kodi setup dialog with dedicated error alerts and expand the Kodi add-on documentation ([6aaf39d](https://github.com/DryKillLogic/comet/commit/6aaf39d3e637e330941b40e3bb96c47ad69b4225))
* implement a Kodi repository build system, including a new Makefile, generation script, repository definition, and GitHub Actions workflow ([cd2f6ab](https://github.com/DryKillLogic/comet/commit/cd2f6ab470eea9154ad73b83549cee9f3121af1e))
* implement Cinemeta as a fallback for IMDB metadata retrieval and centralize year parsing into a new utility module ([29d79c1](https://github.com/DryKillLogic/comet/commit/29d79c100bc16213be23a0fd3c4cf2b1f1588948))
* implement debrid account cache cleanup functionality and related migrations ([1278146](https://github.com/DryKillLogic/comet/commit/1278146bd3a85935f8288a2c529544131a07f5ae))
* implement debrid account torrent scraping ([c36475b](https://github.com/DryKillLogic/comet/commit/c36475bd7c135c4bf0de637ab167607ffacb0747))
* implement episode matching policy for improved media handling ([02c0569](https://github.com/DryKillLogic/comet/commit/02c05695895c41d1ff772d49919d42f3dfeacd25))
* implement episode matching policy for improved media handling ([d406bb5](https://github.com/DryKillLogic/comet/commit/d406bb5828c8b892c291a50fa63c4a938ef5d7e7))
* implement queue-based backpressure and discovery pausing for the background scraper using watermarks ([af664a7](https://github.com/DryKillLogic/comet/commit/af664a716beb19b7863feebc0d70c87628a85bf1))
* implement queue-based backpressure and discovery pausing for the background scraper using watermarks ([6eaff9c](https://github.com/DryKillLogic/comet/commit/6eaff9c8d8ffd3166d6e87335c3634bdc09b8a9c))
* implement resolution-based selection of info hashes for torrent streaming ([1814efa](https://github.com/DryKillLogic/comet/commit/1814efa84c0e54ddb93a2ef8ffce224cc398bc40))
* implement status video responses for debrid sync and playback errors, and add new status video assets ([1ec5383](https://github.com/DryKillLogic/comet/commit/1ec5383561a8eff8ae638945905b5ac244b9ecd8))
* improve Kodi integration with direct VideoInfoTag usage, robust setup, and refined stream info handling ([a62dc06](https://github.com/DryKillLogic/comet/commit/a62dc062c8334efb5fa65a197a6c784928a42e47))
* improve periodic memory trimming with enhanced error handling ([5af2dbe](https://github.com/DryKillLogic/comet/commit/5af2dbe64f1a6a2384f1f105dff1ff9a28381f5c))
* introduce common Docker build workflow and streamline existing workflows ([ca28fb8](https://github.com/DryKillLogic/comet/commit/ca28fb8e49bfd853d806c4c2bf5e9540d7b7b2da))
* introduce Kodi addon with pairing service, setup utilities, and updated documentation ([d27239d](https://github.com/DryKillLogic/comet/commit/d27239d8fbd33d5c549345d9c52ff16efb9dc924))
* log memory trim interval in startup information ([e7288c1](https://github.com/DryKillLogic/comet/commit/e7288c1ab4d0768ee02096ad4acbbc6dc8dbdecb))
* **log_levels:** add KODI custom log level ([25f3a53](https://github.com/DryKillLogic/comet/commit/25f3a53930410721d544eee3ae778e98ce55a97e))
* **media_search:** refine logging for series with season and episode ([19b6b02](https://github.com/DryKillLogic/comet/commit/19b6b023179007e60f386d68864a29417afc8291))
* **network:** add AIOStreams user IP header to proxy headers ([173296d](https://github.com/DryKillLogic/comet/commit/173296d7d839cbe997a2e97af3c96bd8c8645ddd))
* **observability:** add documentation for multi-replica Prometheus deployment ([6820e00](https://github.com/DryKillLogic/comet/commit/6820e0044fff3c4482af7610c0ce12f5c3ec3a4d))
* **observability:** add Grafana dashboard preview and image asset ([261da21](https://github.com/DryKillLogic/comet/commit/261da21ec80f1e8e9cd4fe4b4cbb6fc980a77ddf))
* **observability:** add Prometheus metrics and Grafana dashboards ([ed71812](https://github.com/DryKillLogic/comet/commit/ed7181227c0125e53b4a48c1a65f25a24ebf3595))
* **observability:** enhance Prometheus metrics authentication and update documentation for configuration ([3801780](https://github.com/DryKillLogic/comet/commit/38017809c3ff207ebafb417a084b68d5b61cb223))
* **observability:** refactor Prometheus integration and update Grafana dashboard queries ([73e5bb9](https://github.com/DryKillLogic/comet/commit/73e5bb91971731bf235563550bc03b57450aa796))
* **observability:** streamline Grafana admin password generation in Docker setup ([5a7d19a](https://github.com/DryKillLogic/comet/commit/5a7d19aab9ba21b45c9e358413645149e4b0bd66))
* **observability:** update Docker Compose instructions for Prometheus and Grafana setup ([f40ef95](https://github.com/DryKillLogic/comet/commit/f40ef9587b3511b67713b39e594459d5045eabe8))
* optimize queue snapshot retrieval in BackgroundScraperWorker by consolidating database queries and normalizing discovery limits ([dabbee5](https://github.com/DryKillLogic/comet/commit/dabbee5c5bd749f5d0006edce852481e5d4f7216))
* refactor authentication handling in CometNet UI ([e104a74](https://github.com/DryKillLogic/comet/commit/e104a740beef49e01291697cb3ac2fabdcec117e))
* refactor authentication handling in CometNet UI ([f859926](https://github.com/DryKillLogic/comet/commit/f85992684a13c3e3327f27383e38ecc3c11e60bd))
* remove Latin diacritics from titles for improved indexer compatibility ([de8c8f8](https://github.com/DryKillLogic/comet/commit/de8c8f8441dff724ff7079ebbf9a1eef20c13ca5))
* schedule debrid account sync tasks as background tasks when warm sync does not time out ([577a83e](https://github.com/DryKillLogic/comet/commit/577a83eec9cc6a7889d7d0f87ff19c811c017e77))
* **scraper:** add context-aware timeout policies ([07f6668](https://github.com/DryKillLogic/comet/commit/07f66689860d89687e8b6c72e251285a8d93d2f1))
* **scraper:** add context-aware timeout policies ([69b1f32](https://github.com/DryKillLogic/comet/commit/69b1f32daed02d683bec92241b9e019acb6041ea))
* **scraper:** enhance timeout resolution for indexer managers and add related tests ([dfad7b8](https://github.com/DryKillLogic/comet/commit/dfad7b85b828cfd2c5af4fe51a6098264b5cc7b3))
* **scraper:** include indexer name in tracker for StremthruScraper ([4e95961](https://github.com/DryKillLogic/comet/commit/4e959618204bbc1910feb57c6904d68af94eafee))
* **scraper:** measure and log response time in scrape wrapper and filter manager ([d2785c2](https://github.com/DryKillLogic/comet/commit/d2785c2a8441360f342374d98fbf3fe15cb2add3))
* switch to the Rust filename parser ([d12f80c](https://github.com/DryKillLogic/comet/commit/d12f80cf9dea7b391aceed6ee012122410522e52))
* **tests:** add StremthruScraper tests and TrashRankModel to CometSettingsModel ([bcdbdfc](https://github.com/DryKillLogic/comet/commit/bcdbdfc9b7708ed218c053e8247f55b7974d2660))
* **tests:** add test for Gunicorn control socket configuration ([907acc4](https://github.com/DryKillLogic/comet/commit/907acc4ed2626300c2226a463b5c3be8e88e7e8a))
* **tests:** add unit tests for template response handling in admin and config endpoints ([8eb98c5](https://github.com/DryKillLogic/comet/commit/8eb98c522384fc45fa3fa126d3d84c1fe70f5afc))
* **torznab:** add native Torznab search endpoint ([fa6da35](https://github.com/DryKillLogic/comet/commit/fa6da35233fc3c90e3dc13d71bd80ca0a69ac19e))
* **torznab:** add native Torznab search endpoint ([a49a41b](https://github.com/DryKillLogic/comet/commit/a49a41b99eec5108498cccd9af4e488e64e7a268))
* **torznab:** add Torznab client integration and update documentation ([c32f3cb](https://github.com/DryKillLogic/comet/commit/c32f3cbf0dbe7109b50526caa8bacd2f652b99f8))
* **torznab:** refactor magnet link generation and improve torrent serialization ([bf534dc](https://github.com/DryKillLogic/comet/commit/bf534dcc71898e7e5049c2e0f2e4114bdacc91be))
* track and handle completion of debrid account sync background tasks ([041a3ac](https://github.com/DryKillLogic/comet/commit/041a3acc0e658647e5bf8603979fc3901ef6a353))
* update Kodi integration with new configuration handling, improved manifest URL generation, and enhanced user prompts ([43964ac](https://github.com/DryKillLogic/comet/commit/43964accbc8e80c570acc843bc0175b4caed0aa0))
* update status video assets and enhance error handling in StremThru class ([ba10378](https://github.com/DryKillLogic/comet/commit/ba10378a9e00754a0a7a056b5005e768a0924e72))
* update TPR link ([bc012df](https://github.com/DryKillLogic/comet/commit/bc012dfbfd69e67fc8783e43c75b4a51bff65f91))


### Bug Fixes

* add config route with prefix when configuration password is enabled ([a9a3892](https://github.com/DryKillLogic/comet/commit/a9a389255889274f6ecef11a2b35031e82046516))
* add HTTP status error handling to AnimeTosho and correct status attribute usage in Nyaa ([b188eda](https://github.com/DryKillLogic/comet/commit/b188edadd5e0d5d0cdb06ccac2a99e65abba80e7))
* add missing API key header in Trakt aliases request ([3db3769](https://github.com/DryKillLogic/comet/commit/3db37694df23054e5206254dfebdea6f680114de))
* add validation to sanitize next URL in configuration endpoint to prevent backslashes ([d64302c](https://github.com/DryKillLogic/comet/commit/d64302cc253b206cbd7123d56328ba5304526c5b))
* adjust background scraper cycle timing to account for missed cycles ([39da5c5](https://github.com/DryKillLogic/comet/commit/39da5c5d2ed3182587902f444f8a26458d61280f))
* **admin:** harden live dashboard rendering ([4a98ae0](https://github.com/DryKillLogic/comet/commit/4a98ae07495cd0f85c674fc6480e56686dcceebe))
* **admin:** validate and coalesce update checks ([584c38b](https://github.com/DryKillLogic/comet/commit/584c38b8f0601a652fb4fcf73ca851a10a6f2915))
* **admin:** validate cached metrics ([149efa6](https://github.com/DryKillLogic/comet/commit/149efa6fc81e55d0cf8246955be4d769a5c03ad5))
* allow debrid-verified season packs in account snapshots ([0529c04](https://github.com/DryKillLogic/comet/commit/0529c049fb882dd4001d78a566ff769b3e39625f))
* ambigus query ([41874cb](https://github.com/DryKillLogic/comet/commit/41874cb81d475595e59aac8b0cdf6f5ed5bc03d5))
* **anime:** handle list imdb_id from Fribb ([a26cc5c](https://github.com/DryKillLogic/comet/commit/a26cc5cd02f2ef2878ea47df1af949c6bde96e40))
* **anime:** own background refresh task ([f7084de](https://github.com/DryKillLogic/comet/commit/f7084de338283ffc3720fb02e225204f5103da93))
* **anime:** publish mapping atomically ([cd981bc](https://github.com/DryKillLogic/comet/commit/cd981bc1c90db99825b38df07d80043f9bda445d))
* **anime:** reload mapping caches atomically ([5ea0553](https://github.com/DryKillLogic/comet/commit/5ea055301f276c27a3205cc006f9e8e2bdc45704))
* **anime:** validate cached mapping data ([bc084ea](https://github.com/DryKillLogic/comet/commit/bc084ea3b05b1439d58696828d6604ea627a76aa))
* **auth:** enforce current signed session contract ([07f5861](https://github.com/DryKillLogic/comet/commit/07f5861f68ab9a5a7bfba733226360927130ec59))
* **background:** atomically requeue dead work ([b0accf6](https://github.com/DryKillLogic/comet/commit/b0accf6beb2dd9567e01e69e4a999fa776944976))
* **background:** calculate queue age from eligibility time ([9ed8119](https://github.com/DryKillLogic/comet/commit/9ed81191459e776e24f3b2734110988534578c9b))
* **background:** calculate queue age from eligibility time ([061091e](https://github.com/DryKillLogic/comet/commit/061091edd81f1d71b0c46951b5e7de5e4c48df34))
* **background:** finalize scraper lifecycle ([1a590a2](https://github.com/DryKillLogic/comet/commit/1a590a22cddc70ea2b4869725cbc336da6b59e9d))
* **background:** validate Cinemata discovery data ([9448c0b](https://github.com/DryKillLogic/comet/commit/9448c0bb5f0c87b8166d930f51465581b48595fa))
* **background:** validate status query schema ([7b58bed](https://github.com/DryKillLogic/comet/commit/7b58bedfc3a99fae22914d4a33e5484d93161c2c))
* **bandwidth:** complete shutdown lifecycle ([d9267cd](https://github.com/DryKillLogic/comet/commit/d9267cde3fda617a25d1efec37d6146661fe8bac))
* **cache:** await scrape queue handoff ([4c3108d](https://github.com/DryKillLogic/comet/commit/4c3108de81ece48b3eb41d8082fc68e52ffb5e1a))
* **cache:** isolate invalid parsed data ([efb99f8](https://github.com/DryKillLogic/comet/commit/efb99f860848ee7ffea93c48b778d3d8d03361c2))
* **cache:** preserve empty scrape retries and throttle demand writes ([0de0302](https://github.com/DryKillLogic/comet/commit/0de03023c0febff0cec59e5de57f823638c0bbfd))
* **chilllink:** improve media_id construction for series type ([9cb1a8a](https://github.com/DryKillLogic/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
* chunk `execute_many` calls for SQLite to respect its parameter limit ([2352aa6](https://github.com/DryKillLogic/comet/commit/2352aa6a0f0e138b9d4c586903e1ff028fbafaa1))
* **cometnet:** add end-to-end IPv6 support ([de1e381](https://github.com/DryKillLogic/comet/commit/de1e381ae353a6fc57f162332cd8cd8d9b65e3c7))
* **cometnet:** add end-to-end IPv6 support ([3eb9988](https://github.com/DryKillLogic/comet/commit/3eb9988a4cec56ed940a9d6adc713b3dc8235e15))
* **cometnet:** authenticate transport control frames ([efbe197](https://github.com/DryKillLogic/comet/commit/efbe1976ec8c5356aec671b31cf98952c856f2cf))
* **cometnet:** batch sign torrents in batch broadcast endpoint ([f59712c](https://github.com/DryKillLogic/comet/commit/f59712c685e32588525e0423c3b8783eaa45a089))
* **cometnet:** batch sign torrents in batch broadcast endpoint ([a349013](https://github.com/DryKillLogic/comet/commit/a3490133d19a723bac843fad831b4064f8f69f7d))
* **cometnet:** bind verified keys to handshakes ([229a775](https://github.com/DryKillLogic/comet/commit/229a7752660229fbc346a9b90e147e7db0e8ad68))
* **cometnet:** certify member departures ([8d896f9](https://github.com/DryKillLogic/comet/commit/8d896f9d18fac438b8a0ba7028832ee1574a5feb))
* **cometnet:** clarify invalid websocket proxy handshakes ([75326c9](https://github.com/DryKillLogic/comet/commit/75326c9bc5ea9434d0c1aa72a902365b2bdb7e83))
* **cometnet:** clarify invalid websocket proxy handshakes ([70947a1](https://github.com/DryKillLogic/comet/commit/70947a1768b7e16a7d438238420e953e51c63860))
* **cometnet:** clean partial startup ([3831906](https://github.com/DryKillLogic/comet/commit/38319060a7a1e2c5a17af6966f538d1d55fd1584))
* **cometnet:** complete teardown after failures ([c922a9d](https://github.com/DryKillLogic/comet/commit/c922a9d9c14fc5596d4cfec35d0205549cb1beee))
* **cometnet:** detect websocket upgrades via Sec-WebSocket-Key when Connection header is stripped by upstream proxy ([37f7206](https://github.com/DryKillLogic/comet/commit/37f720661d362b3f35fe49e3e8574b7c49b87443))
* **cometnet:** drain relay sends on shutdown ([9977d0a](https://github.com/DryKillLogic/comet/commit/9977d0a98e0a2c70f0c90350543dddb9343b4d59))
* **cometnet:** enforce auxiliary state schema ([685a439](https://github.com/DryKillLogic/comet/commit/685a4395dc672d04a333af7b18a09a63d1230d30))
* **cometnet:** enforce current message schema ([a55b8e1](https://github.com/DryKillLogic/comet/commit/a55b8e19c17d3578cddefd24bbe49cf6815862ea))
* **cometnet:** enforce current pool authority ([9e1fa19](https://github.com/DryKillLogic/comet/commit/9e1fa1997af8e1c695485e2ada6e6a23f19e3001))
* **cometnet:** enforce discovery state schema ([52d41ec](https://github.com/DryKillLogic/comet/commit/52d41ecc433331598df66ee68778d3d7de557ab6))
* **cometnet:** enforce reputation state schema ([639367f](https://github.com/DryKillLogic/comet/commit/639367fe27c9a1dadadf9cda19ede95649908701))
* **cometnet:** enforce strict admin API contracts ([375c3c6](https://github.com/DryKillLogic/comet/commit/375c3c61324073b3602df6ef7b92220f94b118b9))
* **cometnet:** fail closed on message authentication ([277bdb2](https://github.com/DryKillLogic/comet/commit/277bdb2135f2e0dfde2ac13c5a77aa14ac04ead1))
* **cometnet:** handle IPv6 addresses in host formatting ([eefb140](https://github.com/DryKillLogic/comet/commit/eefb14076d547bb6522c9e38a23082518f4f63a5))
* **cometnet:** make contribution flush durable ([25ef574](https://github.com/DryKillLogic/comet/commit/25ef5747de16000b81e0a24ef4508c1427df97c4))
* **cometnet:** make peer cleanup identity safe ([d4b5b50](https://github.com/DryKillLogic/comet/commit/d4b5b50d9e3312ecefbbcb7c930b85a28f616e82))
* **cometnet:** make standalone lifecycle transactional ([2fa2bee](https://github.com/DryKillLogic/comet/commit/2fa2beef58360c7f4f39374a78b6f94e9f3f3e78))
* **cometnet:** order pool deletion state ([d5e05e2](https://github.com/DryKillLogic/comet/commit/d5e05e2464ea3970225452b4f641e4438acc22d2))
* **cometnet:** own background tasks ([f95d673](https://github.com/DryKillLogic/comet/commit/f95d6737182d6ad27d4f4fa2adc29bf9a300ef42))
* **cometnet:** own transport ping sends ([a744cb0](https://github.com/DryKillLogic/comet/commit/a744cb0e90345fa918278baf9880e5cf91929365))
* **cometnet:** persist pool state before publish ([fda02ee](https://github.com/DryKillLogic/comet/commit/fda02ee8e0ffd5abdd4ce168ef89339164618793))
* **cometnet:** persist state atomically ([e8b0136](https://github.com/DryKillLogic/comet/commit/e8b0136aa5c322eb346ed7071b51525846c4aca7))
* **cometnet:** preserve pending gossip ([ad95158](https://github.com/DryKillLogic/comet/commit/ad9515835bacf2a83d44467f88d9f65e306b8b93))
* **cometnet:** preserve trusted pool authority ([3b0c4cf](https://github.com/DryKillLogic/comet/commit/3b0c4cf931d7f12acc61f17dbe3aaaedf885a2a2))
* **cometnet:** publish persisted pool manifests ([2f275ad](https://github.com/DryKillLogic/comet/commit/2f275ad0e131c4abcb462a377415801a83a6e01c))
* **cometnet:** reject unverified duplicate relays ([98bc91b](https://github.com/DryKillLogic/comet/commit/98bc91b3c295d8eb0eb6289e38628c3fbe1b3c8c))
* **cometnet:** release duplicate peer slots ([9fdc57f](https://github.com/DryKillLogic/comet/commit/9fdc57fe82c814d834a58ce3c074df5b1e2474cb))
* **cometnet:** release per-IP slot on peer disconnect ([b7e0b3b](https://github.com/DryKillLogic/comet/commit/b7e0b3bf54da9929ea49d0c6dc56532e1910572a))
* **cometnet:** reserve handshake capacity ([eae70bb](https://github.com/DryKillLogic/comet/commit/eae70bb65049f0310fd8b2632fa17fe207cab025))
* **cometnet:** restore state transactionally ([85a0540](https://github.com/DryKillLogic/comet/commit/85a05405009c4b16e470538a37f57e25746b422a))
* **cometnet:** serialize invite consumption ([2573b41](https://github.com/DryKillLogic/comet/commit/2573b413d34dce5544ed933cf1cba15d1517524d))
* **cometnet:** serialize pool lifecycle state ([ed97af5](https://github.com/DryKillLogic/comet/commit/ed97af58a25a6b181aaf01fa0bd02f82fad7c8ae))
* **cometnet:** serialize pool member mutations ([0404ca4](https://github.com/DryKillLogic/comet/commit/0404ca4c80ddec5c189548e56c9645ce8d930d0a))
* **cometnet:** serialize remote member deltas ([0c1ae64](https://github.com/DryKillLogic/comet/commit/0c1ae64ad344fe2a09f7a5c4ff1083724dfe0ad7))
* **cometnet:** sign persisted node state ([141105f](https://github.com/DryKillLogic/comet/commit/141105f6bd3f1093159db110c81bbe3293bb9141))
* **cometnet:** surface pool storage failures ([e62eb2e](https://github.com/DryKillLogic/comet/commit/e62eb2e012470b812e3dc81682699e4d8181ae8c))
* **cometnet:** surface transport runtime failures ([a28104e](https://github.com/DryKillLogic/comet/commit/a28104eab2b271a64128fa4aa3d1192c48e60654))
* **cometnet:** validate persisted pool data ([06e36e9](https://github.com/DryKillLogic/comet/commit/06e36e962f07d381139b1d394de8cb19e9954654))
* **cometnet:** validate persisted pool manifests ([fb0650a](https://github.com/DryKillLogic/comet/commit/fb0650a8a2fd8d6c6cd843df0a3a4208fa012a38))
* **cometnet:** validate pool message content ([a4eedf6](https://github.com/DryKillLogic/comet/commit/a4eedf6e5600f1e1bdfb97f64496326371d56667))
* **cometnet:** validate relay batch results ([604c3ed](https://github.com/DryKillLogic/comet/commit/604c3ed65db4866ae4ceccc15ed27cc046f84f58))
* **cometnet:** validate signed numeric fields ([8273624](https://github.com/DryKillLogic/comet/commit/82736244027be2f11b2be1fdd28516c87a1ad986))
* **cometnet:** validate state before restore ([c699613](https://github.com/DryKillLogic/comet/commit/c699613099b82ea383d2c2e94135f4037ab7e868))
* **config:** reject invalid scraper modes ([54bedca](https://github.com/DryKillLogic/comet/commit/54bedca97ee4bb01295f437be8a453044420840a))
* **config:** require aligned scraper credentials ([3b39b7f](https://github.com/DryKillLogic/comet/commit/3b39b7f57d12703bee9e7d4a8569c3e83cd6e6e8))
* **config:** require positive worker counts ([b6d8ca9](https://github.com/DryKillLogic/comet/commit/b6d8ca90a1d651368928689ec0c126a84ef8eff4))
* **config:** restore saved filters and update Punjabi flag ([d75a0e5](https://github.com/DryKillLogic/comet/commit/d75a0e543a8a32d14f60d15813be3de9afde5674))
* **config:** restore saved filters and update Punjabi flag ([8caddf6](https://github.com/DryKillLogic/comet/commit/8caddf6799c21366c22c850cc30fcb7c1768231f))
* **config:** validate CometNet operation values ([c21cfb7](https://github.com/DryKillLogic/comet/commit/c21cfb7266fcb8acdb653d85d964b4be34e70f5a))
* correct bandwidth statistics update logic ([d1e37bb](https://github.com/DryKillLogic/comet/commit/d1e37bb81e7f7fcea24cce36de896b231da3e3b7))
* correct tracker extraction logging for SeaDex scraper ([44aa0d8](https://github.com/DryKillLogic/comet/commit/44aa0d840b71b1ca5e543b3373cd3db23ec36a96))
* **database:** contain replica routing failures ([097bfdd](https://github.com/DryKillLogic/comet/commit/097bfdde1e56c2ec6583fc6b44a819362cda07dd))
* **database:** disconnect after setup failure ([4634028](https://github.com/DryKillLogic/comet/commit/46340282f38541cbeebcf07e07424b89a329c0ee))
* **debrid:** close StremThru responses ([45415f0](https://github.com/DryKillLogic/comet/commit/45415f018c140d967c60c4ce3a97d4d7fd06b1a0))
* **debrid:** merge service enrichments deterministically ([62bc384](https://github.com/DryKillLogic/comet/commit/62bc3849fe380748cfe91b8da1594b43a2817084))
* **debrid:** own cache write tasks ([427f5ca](https://github.com/DryKillLogic/comet/commit/427f5caa489cd33c2e449167a4a6115911d9b68e))
* **debrid:** prepare availability responses once ([12da600](https://github.com/DryKillLogic/comet/commit/12da6003bd59922ac1a4e49d117a72ce0c0eccce))
* **debrid:** preserve duplicate account fallback ([47194a7](https://github.com/DryKillLogic/comet/commit/47194a7d1e0ed8d83903b17e19cdcfb5906a8314))
* **debrid:** replace account snapshots atomically ([d6c9326](https://github.com/DryKillLogic/comet/commit/d6c9326ad466dde6dd3ff2965e2c5d8c47019b2e))
* **debrid:** stop account sync tasks cleanly ([58ffd5d](https://github.com/DryKillLogic/comet/commit/58ffd5dc0a15c920ac70038225a53b263c6e9002))
* **debrid:** surface unexpected link errors ([b9cc271](https://github.com/DryKillLogic/comet/commit/b9cc271a28fe655ba0d63aef05f3dd21f800f5f8))
* **deps:** update torrent-parse-rank source to latest commit ([4f11532](https://github.com/DryKillLogic/comet/commit/4f11532057934ca1539fd5bf925f1b2dae2a54fc))
* **dmm:** keep failed hashlists retryable ([7833f36](https://github.com/DryKillLogic/comet/commit/7833f369bc2800d89da908243c9983b92efc014c))
* **dmm:** reject unsafe archive members ([980070b](https://github.com/DryKillLogic/comet/commit/980070b067b09d3396f9bc7002e80a922374e787))
* **docker:** remove unnecessary user creation and ownership in Dockerfile ([3cf92a4](https://github.com/DryKillLogic/comet/commit/3cf92a4de9b9305bb5dda0bbcac4e55779206907))
* don't use DOMContentLoaded as it isn't needed ([a30637c](https://github.com/DryKillLogic/comet/commit/a30637c6025f11f2ec3b98b2e6732fd342f125aa))
* don't use DOMContentLoaded as it isn't needed ([15d405e](https://github.com/DryKillLogic/comet/commit/15d405efdff7627ea710910672f866eaf677096a))
* enforce media ID requirement for torrent operations ([44f423d](https://github.com/DryKillLogic/comet/commit/44f423d4be229b487de1863ac903da2232f997ee))
* enforce non-empty imdb_id requirement in torrent metadata ([386b4dd](https://github.com/DryKillLogic/comet/commit/386b4dd1ad75badd43031c73cfc445aa4f37f168))
* enhance error handling in StremThru class for missing download links and update error type in generate_status_videos.py ([0ebe670](https://github.com/DryKillLogic/comet/commit/0ebe670979eb4998b22e8a27fb5246b2b8b6e4f3))
* enhance error logging in info hash normalization ([26ecdf2](https://github.com/DryKillLogic/comet/commit/26ecdf2310c36afaf10dd15c41c20721dfc0d7ab))
* ensure default last_seen time is used when sorting keys in PublicKeyStore ([b7bf69e](https://github.com/DryKillLogic/comet/commit/b7bf69e620d6b89bed05f7e72fe8b8bfda169dbb))
* ensure proper cancellation of in-flight tasks in BackgroundScraperWorker during cancellation ([5d4c5fd](https://github.com/DryKillLogic/comet/commit/5d4c5fd70ac1f004b90e01f67ea5634230fc19c3))
* ensure season and episode checks in `parsed_matches_target` handle None values correctly ([0a9ace9](https://github.com/DryKillLogic/comet/commit/0a9ace9db0efef99823497bcbaa0a9bfd5072a75))
* **entrypoint:** propagate server startup failures ([b575549](https://github.com/DryKillLogic/comet/commit/b5755497705e3fe94f3d5e30276ecb22d6a359ed))
* exclude miniupnpc version 2.3.3 and update to 2.3.2 ([a168860](https://github.com/DryKillLogic/comet/commit/a1688600238666e812e8f597d17aa934369ddd1e))
* **filtering:** match multi-title releases with a foreign first title ([00063cf](https://github.com/DryKillLogic/comet/commit/00063cf73c02a80dedd271eba5a202f7868851b6))
* **filtering:** match multi-title releases with a foreign first title ([8697e1b](https://github.com/DryKillLogic/comet/commit/8697e1beefe2258a73a15a0c7688c7a1553a5e27))
* **filtering:** normalize current aliases ([3ade6d7](https://github.com/DryKillLogic/comet/commit/3ade6d7cf229740f083bcdb84ab7eec4d0809c2a))
* **filtering:** reject empty alias matches ([5bd140c](https://github.com/DryKillLogic/comet/commit/5bd140c858351544fbb709ac575d4ee58e8314a2))
* **formatting:** simplify director's cut condition check ([9cb1a8a](https://github.com/DryKillLogic/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
* handle missing video size in torrent behavior hints ([bab5445](https://github.com/DryKillLogic/comet/commit/bab5445a785c46bd4ad1e67198af088692d0a2fd))
* handle tracker extraction more robustly by ensuring it defaults to None when not present ([7fd92bc](https://github.com/DryKillLogic/comet/commit/7fd92bc83ffdbad082ce94d0d4aaf5db1967f6b6))
* **http:** enforce cache and client runtime contracts ([8650b08](https://github.com/DryKillLogic/comet/commit/8650b08aa47d71c5806c72e788451a398bf80540))
* import gunicorn in run_with_gunicorn function to fix windows issues ([7f89f7a](https://github.com/DryKillLogic/comet/commit/7f89f7a1ee2c09dcfc8f0dcb2799de060ffd365b))
* import gunicorn in run_with_gunicorn function to fix windows issues ([cecb61e](https://github.com/DryKillLogic/comet/commit/cecb61e8d85c5387f4ae6a46a4aec0831dd7e17c))
* improve type hinting for configuration parameters and enhance error logging in token persistence ([3588754](https://github.com/DryKillLogic/comet/commit/358875449d76aae8b321d4bd7e0edda931f94c30))
* **indexers:** close Prowlarr responses ([a3a0466](https://github.com/DryKillLogic/comet/commit/a3a046632e48dda96bda554367d159b761b004b9))
* **indexers:** isolate malformed health records ([fecfcf0](https://github.com/DryKillLogic/comet/commit/fecfcf0112d36dd30a16b7f6eeac1fd57512ea54))
* **kodi:** isolate malformed catalog metadata ([4f51b46](https://github.com/DryKillLogic/comet/commit/4f51b460671e96e73ed56fa2b7772ef2d33f350c))
* **kodi:** isolate malformed stream entries ([bc82536](https://github.com/DryKillLogic/comet/commit/bc825361944e16de80084dd68c69038567cfef79))
* **kodi:** make setup pairing first-writer wins ([90bc402](https://github.com/DryKillLogic/comet/commit/90bc402a13b5ae59311c37ccfad9d623d7502629))
* **kodi:** require current pairing origin ([e1880e6](https://github.com/DryKillLogic/comet/commit/e1880e648214f529c20b2aa61bb445a77bc3c8bd))
* **kodi:** validate pairing responses ([be75acf](https://github.com/DryKillLogic/comet/commit/be75acf15907dd0d3f898ea70a0064e0283a540a))
* **kodi:** validate stream metadata hints ([aff9a24](https://github.com/DryKillLogic/comet/commit/aff9a2462e21d79545d009baff31b1885a9f3453))
* **lifecycle:** clean partial app startup ([fb3162d](https://github.com/DryKillLogic/comet/commit/fb3162d8a23a48b8f226841d77d1ef0315430c16))
* **lock:** renew leases around long operations ([bf6a6e7](https://github.com/DryKillLogic/comet/commit/bf6a6e79b8798a0b370016ff00f470a8815e4208))
* **metadata:** commit episode index atomically ([0b317d3](https://github.com/DryKillLogic/comet/commit/0b317d34bf9c5506af5fbd2adf8e44239c8e872f))
* **metadata:** isolate malformed Kitsu fields ([232d374](https://github.com/DryKillLogic/comet/commit/232d3746fd8cabf13c14ebf208fdbcce7085083c))
* **metadata:** isolate malformed provider results ([bf6a86e](https://github.com/DryKillLogic/comet/commit/bf6a86ef8366920093c8f4e83a76df3191f66425))
* **metadata:** isolate malformed TMDB results ([d2d1559](https://github.com/DryKillLogic/comet/commit/d2d15591a8c0812be84f77ea743c76dfcdfffe8b))
* **metadata:** parse Trakt aliases deterministically ([fc2a757](https://github.com/DryKillLogic/comet/commit/fc2a757df68d2261ae4cb3e23cda452562b5be9f))
* **metadata:** replace stale episode index rows ([5af7397](https://github.com/DryKillLogic/comet/commit/5af739700f5545125bd5604573a2ec6378ce9b4a))
* **metadata:** validate cached episode dates ([aa92f4c](https://github.com/DryKillLogic/comet/commit/aa92f4c871a285be2229b21dfa93d782faa7ec33))
* **models:** replace random password generation with secure secret generation ([9cb1a8a](https://github.com/DryKillLogic/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
* optimize search metrics query in admin API ([610f7e7](https://github.com/DryKillLogic/comet/commit/610f7e7fb9fcc0be7ecd3e2cc9cd31c49cb9568d))
* pin mediaflow-proxy dependency to version 2.4.1 for compatibility ([a69a1df](https://github.com/DryKillLogic/comet/commit/a69a1dfefa5de052a2cfc1bee50bd90ef19e28d9))
* **playback:** Fix name_query not being parsed ([798bf80](https://github.com/DryKillLogic/comet/commit/798bf8002c6f98646a4986c9cef919b515aa93b6))
* **playback:** Fix name_query not being parsed ([458be8c](https://github.com/DryKillLogic/comet/commit/458be8c857cc9f5716aab87f26378090431fa6f0))
* **playback:** isolate cache failures ([01daab7](https://github.com/DryKillLogic/comet/commit/01daab7f4a3302e2bdf0d88207191f6b383ad069))
* **playback:** require canonical request scope ([5106b79](https://github.com/DryKillLogic/comet/commit/5106b799780b0a1e6ed38ff4ec670f2454c17935))
* **playback:** Validate and strip torrent name and video name parameters ([2476bb0](https://github.com/DryKillLogic/comet/commit/2476bb02de86c96d6d606fa70d8cd3083e6218e3))
* prevent auto-scrolling when new logs are appended if not at the bottom ([5457db0](https://github.com/DryKillLogic/comet/commit/5457db0143fa19cd6056d8531f0fe20860cb10e1))
* prevent auto-scrolling when new logs are appended if not at the bottom ([19bf51f](https://github.com/DryKillLogic/comet/commit/19bf51f64d981d07c37a94811fcf0f687ff10c37))
* **ranking:** surface unexpected torrent errors ([ba34381](https://github.com/DryKillLogic/comet/commit/ba343813f7d882b06712c4fd248ef62b7194e5c4))
* **scrapers:** cancel unfinished provider tasks ([f6f06da](https://github.com/DryKillLogic/comet/commit/f6f06da554626669e1f926eec8ad9908b8a2efb1))
* **scrapers:** close Zilean responses ([d48a49a](https://github.com/DryKillLogic/comet/commit/d48a49aca9d3ee430cb2387f0dd5348899f12ceb))
* **scrapers:** isolate credential header caches ([499e92e](https://github.com/DryKillLogic/comet/commit/499e92ee3a034b0ddcb1954612e181885a110539))
* **scrapers:** isolate indexer result failures ([d086f10](https://github.com/DryKillLogic/comet/commit/d086f1021b3e9bc0cf3693534d35d8138afd9f32))
* **scrapers:** isolate malformed addon streams ([595c4ed](https://github.com/DryKillLogic/comet/commit/595c4ed526935e9f2b8364db4a4f686f524489fb))
* **scrapers:** isolate malformed addon streams ([044ddef](https://github.com/DryKillLogic/comet/commit/044ddefc89d1014637518faf6f764882994708e8))
* **scrapers:** isolate malformed Torrentio streams ([135d2e8](https://github.com/DryKillLogic/comet/commit/135d2e84c2f8598f3f5fd5495a901159833e733e))
* **scrapers:** keep torrent rows aligned ([dc44b9d](https://github.com/DryKillLogic/comet/commit/dc44b9dcb3cf79259950b049760b47edad920e87))
* **scraper:** skip invalid magnet titles in StremthruScraper ([3136b9c](https://github.com/DryKillLogic/comet/commit/3136b9cbe731aa8941eba0b93fe21b227e289127))
* **scrapers:** preserve valid nested results ([481853a](https://github.com/DryKillLogic/comet/commit/481853afda81c70b013f19dfb6515d1bae3c067e))
* **scrapers:** validate aggregate result schema ([dc6e5fc](https://github.com/DryKillLogic/comet/commit/dc6e5fc6be12ce6251271e2846734a25fdd251c9))
* **scraper:** update scraper type hint for better clarity ([9cb1a8a](https://github.com/DryKillLogic/comet/commit/9cb1a8af71c4d8a5292fae30333588771d1da0fe))
* **scripts:** publish validated status assets atomically ([93650e8](https://github.com/DryKillLogic/comet/commit/93650e81949cf7805fba09b4bee8e306d954f4c4))
* **series:** support aggregate searches and scoped debrid caching ([ce5cae5](https://github.com/DryKillLogic/comet/commit/ce5cae50a86449a40e744c81dc22eb96b7d88e12))
* **series:** support aggregate searches and scoped debrid caching ([c2d3d79](https://github.com/DryKillLogic/comet/commit/c2d3d79cbf2897b96cc299bb45c45535c369ff12))
* simplify metadata_updated_at assignment in SQL queries ([952217e](https://github.com/DryKillLogic/comet/commit/952217ece69d76377054e79d85d43a5c00a2724d))
* simplify metadata_updated_at assignment in SQL queries ([6298755](https://github.com/DryKillLogic/comet/commit/6298755ea0382b778551020924231fd723ebd354))
* **storage:** durably replace state files ([8b77186](https://github.com/DryKillLogic/comet/commit/8b771868b24b1a7cf059c8be66a3982c440a9735))
* **streaming:** complete connection cleanup ([8e22225](https://github.com/DryKillLogic/comet/commit/8e22225bbbdd9d62016bcd84b09af52c624e8519))
* **streaming:** serialize connection admission ([2a59a7c](https://github.com/DryKillLogic/comet/commit/2a59a7c7b0ef122b45c77ceac707fb88b4d31102))
* **torrents:** isolate corrupt file entries ([aaca327](https://github.com/DryKillLogic/comet/commit/aaca32786f8124059abe147e494f02d8be06930d))
* **torrents:** isolate invalid persistence rows ([26bf81c](https://github.com/DryKillLogic/comet/commit/26bf81c615cad1b462b3077836cf8403d8fc4d14))
* **torrents:** preserve valid metadata on partial corruption ([97cc2a1](https://github.com/DryKillLogic/comet/commit/97cc2a1ace57626060f9f89b8f61cef0d8b5f5b6))
* tracker extraction result is discarded ([9448806](https://github.com/DryKillLogic/comet/commit/9448806ea5a8ad1fd7581d8353ad9c72d0ae2f01))
* **ui:** Offcloud now uses an API key, not email:password ([a1c6323](https://github.com/DryKillLogic/comet/commit/a1c6323e0d4ad85faa89b746fa11dafb2fcca8de))
* **ui:** Offcloud now uses an API key, not email:password ([c617a16](https://github.com/DryKillLogic/comet/commit/c617a16f5cb9b07e2d0642b9628a12d3d734aef4))
* update anime_entries insert query to handle conflicts by updating existing data ([fa15430](https://github.com/DryKillLogic/comet/commit/fa15430ba298a20f14756a81dc3bd6a37aa4e60f))
* update CONFIGURE_PAGE_PASSWORD default value to None for improved clarity in configuration settings ([4ef1f2d](https://github.com/DryKillLogic/comet/commit/4ef1f2dd2e60ed80c1add25dc14c3a2755574ef4))
* update last_seen_at timestamp in background scraper ([b1fbab5](https://github.com/DryKillLogic/comet/commit/b1fbab57f1fbde799d0acb573f4aabacac72fbfa))
* update lock expiration logic in DistributedLock to refresh based on current loop time ([372efe2](https://github.com/DryKillLogic/comet/commit/372efe28b999eb85129170cae5ecd05e9d6dcb8e))
* update media ID matching logic in background scraper ([52dca3b](https://github.com/DryKillLogic/comet/commit/52dca3b1f0c02d39560693335a8b0452894c759b))
* update miniupnpc dependency and Dockerfile cache configuration ([c31bfe1](https://github.com/DryKillLogic/comet/commit/c31bfe16707c46354b420dd8cdbc6a4e48ecad52))
* update search query timestamps in admin API metrics ([44b7432](https://github.com/DryKillLogic/comet/commit/44b7432f018f310a5448bca04c70b88ba353e653))
* update sqlite in Docker image ([8d868ce](https://github.com/DryKillLogic/comet/commit/8d868ce7b923baaa7455b2bf507c0661af700a00))
* **utils:** reject corrupt identity and size values ([1e8597b](https://github.com/DryKillLogic/comet/commit/1e8597b3388d08d03aaebaad3dc88ceac4d84fdb))


### Performance Improvements

* **background:** read one primary queue snapshot ([6ff5ef1](https://github.com/DryKillLogic/comet/commit/6ff5ef1280ad2c6bf78911ca8c526cf2998fe84b))
* **cache:** overlap independent state probes ([3bfd384](https://github.com/DryKillLogic/comet/commit/3bfd3843663da7346d8ec360176a476877009434))
* **cache:** overlap mapped media reads ([d06419c](https://github.com/DryKillLogic/comet/commit/d06419c2605342e51b71ffd0399c03d8d09fbe62))
* **cometnet:** coalesce relay batch flushes ([05d39d4](https://github.com/DryKillLogic/comet/commit/05d39d45f12d65c1c403a16d265f0d8d47e06344))
* **cometnet:** disable permessage-deflate on WebSocket connections ([d39a0e1](https://github.com/DryKillLogic/comet/commit/d39a0e12194ca051dc5bd1ed4b727ee3e29e51d3))
* **cometnet:** disable permessage-deflate on WebSocket connections ([04bdfe8](https://github.com/DryKillLogic/comet/commit/04bdfe87bd7a750ac9f5ec6833c4b452b72aff6a))
* **database:** cache migration metadata ([6506c57](https://github.com/DryKillLogic/comet/commit/6506c57074e300d9f352c2c06946bed1447eb77c))
* **database:** stream exports with keyset batches ([9f7b16c](https://github.com/DryKillLogic/comet/commit/9f7b16cf8f68cca11142f17ffa951831c10798c3))
* **debrid:** compact availability conflicts ([3282860](https://github.com/DryKillLogic/comet/commit/32828602866749fdbb920c48ccaa8efe42aff50c))
* **debrid:** overlap account freshness probes ([56021d0](https://github.com/DryKillLogic/comet/commit/56021d097e0288a29515b78c17ec67a69b727290))
* **debrid:** overlap refresh state reads ([2356fbb](https://github.com/DryKillLogic/comet/commit/2356fbb1870ffcc3dd416f4394a0722e7a88f08f))
* **filter:** clone only mutable parse state ([0d3799f](https://github.com/DryKillLogic/comet/commit/0d3799fd2e818bf62929dd6d2a6747fab919876e))
* **metadata:** coalesce concurrent refreshes ([f0b5789](https://github.com/DryKillLogic/comet/commit/f0b57898a5b97813dacd86e49901e3c793a01b0d))
* **ranking:** batch RTN scoring ([12416a5](https://github.com/DryKillLogic/comet/commit/12416a56a7dae63b29fbfdee82ea53472501b8ac))
* **ranking:** combine RTN filtering and scoring ([065be08](https://github.com/DryKillLogic/comet/commit/065be08c3776bb11566e14fbfb7501bd34aad519))
