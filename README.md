...
- Supported Scrapers: Jackett, Prowlarr, Torrentio, Zilean, MediaFusion, Debridio, StremThru, AIOStreams, Comet, Jackettio, Peerflix, TorBox and Nyaa
...
- Copy _.env-sample_ to _.env_ in the same directory and keep only the variables you wish to modify, also remove all comments
